...
export function* storeUser({
  ...
  try {
    ...
    const response = yield call(api.post, 'admin/user', {
      name
    });
...
export function* updateUser({
  ...
  try {
    ...
    const response = yield call(api.post, `admin/user/${id}`, {
      name,
...
export function* deleteUser({ payload }) { // payload ini id
  try {
    ...
    // const response = yield call(api.post, `admin/user/${payload}`, {
    yield call(api.post, `admin/user/${payload}`, {
